...
#
# pat_pers_symp = number of domains participant scores in top quartile
# pat_pers_bin = binary version of above indicating whether participant scored in top 
...
pat_pers_mast.data <- extractVars(pat_pers.varlist)
...
pat_monav.varlist <- c("pm5001", "pm5009", "pm5021", "pm5027", "pm5043", "pm5053", 
	                   "pm5072", "pm5076", "pm5101", "pm5108", "pm5129")
...
pat_pers.data <- pat_pers.data %>%
mutate(
  pat_ang_tot = proRate(pat_pers.data, pat_ang.varlist, 3),
  pat_detach_tot = proRate(pat_pers.data, pat_detach.varlist, 3),
  pat_imp_tot = proRate(pat_pers.data, pat_imp.varlist, 3),
  pat_monav_tot = proRate(pat_pers.data, pat_monav.varlist, 3),
  pat_sup_tot = proRate(pat_pers.data, pat_sup.varlist, 3))
...
pat_pers.data <- pat_pers.data %>%
mutate(pat_pers_symp = 
	rowSums(select(pat_pers.data, pat_ang_quart, pat_detach_quart, pat_imp_quart, 
