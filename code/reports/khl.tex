...
%  \begin{center}%
  \let \footnote \thanks
    {\fontsize{24}{20}\headingfont\bfseries\selectfont\color{marrs}\raggedright  \setlength{\parindent}{0pt} \@title \par}%
}
%\fi
\makeatother
...
\titleformat{\section}
   {\fontsize{16}{19.2}\bfseries\color{marrs}\headingfont}% format
   {}% label
   {0pt}% sep
   {\titlerule\addvspace{4pt}}% before code
...
\titlespacing*{\section}{0pt}{19.2pt plus 1ex minus .2ex}{1pt plus .2ex}
\titlespacing*{\subsection}{0pt}{19.2pt plus 1ex minus .2ex}{-7pt plus .2ex}
